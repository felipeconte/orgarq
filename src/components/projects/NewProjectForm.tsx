...
export default function NewProjectForm({ organizationId, templates = [] }: NewProjectFormProps) {
  ...
  // 3. Cliente: E-mail e Telefone
  const [clientEmail, setClientEmail] = useState<string>('')
  const [clientPhone, setClientPhone] = useState<string>('')
  const [emailValid, setEmailValid] = useState<boolean | null>(null)

  // 4. Modelo de Tarefas e Cronograma
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-9 pr-3.5 py-2.5 bg-slate-50/50 border rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 ${emailValid === false
                ...
                <div className="flex items-center gap-2.5">
                  <div
                    className={`w-8 h-8 rounded-xl flex items-center justify-center font-bold ${
                      templateMode === 'template' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'
                    }`}
                  >
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2.5">
                  <div
                    className={`w-8 h-8 rounded-xl flex items-center justify-center font-bold ${
                      templateMode === 'none' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'
                    }`}
                  >
