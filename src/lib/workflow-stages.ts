...
export const STAGE_COLOR_CONFIG: Record<WorkflowStageColor, StageStyleConfig> = {
  ...
  purple: {
    ...
    ganttBar: 'from-purple-600 to-purple-700 border-purple-500/30',
    ganttProgress: 'bg-purple-800',
    kanbanHeader: 'text-purple-900',
    kanbanBg: 'bg-purple-50/40',
    kanbanBorder: 'border-purple-200',
